...
public class MemberReader {
    ...
    public Page<Member> findAllByPartAndYear(Part part, Integer year, Pageable pageable) {
        ...
        List<Role> roles = List.of(Role.ROLE_MEMBER, Role.ROLE_ADMIN);
        Page<Member> memberPage = memberRepository.findAllByPartAndYearAndRoleIn(part, year, roles, pageable);
