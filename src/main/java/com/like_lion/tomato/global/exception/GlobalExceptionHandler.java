...
public class GlobalExceptionHandler {
    ...
    private ResponseEntity<ApiResponse<?>> buildErrorResponse(ErrorCode errorCode) {
        ApiResponse<?> errorResponse = ApiResponse.error(errorCode.toString(), errorCode.getMessage());
        return new ResponseEntity<>(errorResponse, HttpStatus.valueOf(errorCode.getStatus()));
    }

    private ResponseEntity<ApiResponse<?>> buildErrorResponse(ErrorCode errorCode, Object details) {
        ApiResponse<?> errorResponse = ApiResponse.error(errorCode.toString(), errorCode.getMessage(), details);
        return new ResponseEntity<>(errorResponse, HttpStatus.valueOf(errorCode.getStatus()));
    }
