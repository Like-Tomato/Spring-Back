package com.like_lion.tomato.global.auth.application;
...
public class LikeLionOauth2UserService implements OAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        // MemberReader로부터 기존 회원 정보조회(findOptionalByEmail) 후 예외처리
        //UserInfo dto = UserInfo.from(member) Member 객체 구현 후 주석 해제
        //return LikeLionOAuth2User.of(dto);
        return null;
    }
